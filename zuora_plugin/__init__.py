...
from zuora_plugin.operators.zuora_cancel_delinquent_customer_operator import ZuoraCancelDelinquentCustomerOperator

class ZuoraPlugin(AirflowPlugin):
    name = "zuora_plugin"
    operators = [ZuoraToRedshiftOperator, ZuoraBillRunOperator, ZuoraCancelDelinquentCustomerOperator]
